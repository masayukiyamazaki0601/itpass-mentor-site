...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col gap-10 min-w-0">
      ...
      <div className="glass-card-light rounded-3xl p-6 border border-indigo-200/80 shadow-md flex flex-col sm:flex-row items-center justify-between gap-6 bg-gradient-to-r from-white via-indigo-50/40 to-purple-50/40">
        <div className="flex items-center gap-5 w-full sm:w-auto">
          <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-tr from-indigo-600 to-purple-600 flex items-center justify-center text-white shadow-lg shadow-indigo-500/25 flex-shrink-0">
        ...
        <div className="w-full sm:w-64 flex flex-col gap-2">
          <div className="flex justify-between items-center text-xs font-bold">
            ...
            <span className="text-indigo-600 text-sm font-extrabold">{progressPercent}%</span>
          </div>
          <div className="w-full h-3 bg-slate-200/80 rounded-full overflow-hidden p-0.5">
            <div
              className="h-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full transition-all duration-500 shadow-xs"
      ...
      <section className="relative w-full min-h-[440px] rounded-3xl overflow-hidden shadow-xl border border-slate-200/80 flex items-center group">
        ...
        <div className="relative z-20 px-8 sm:px-14 py-12 text-white max-w-3xl">
          ...
          <h1 className="text-3xl sm:text-5xl font-black mb-5 leading-tight tracking-tight drop-shadow-md">
            ...
            <span className="bg-gradient-to-r from-cyan-300 via-indigo-300 to-pink-300 bg-clip-text text-transparent">徹底的かつ直感的にマスター。</span>
          </h1>
          ...
          <form
            ...
            className="bg-white/95 backdrop-blur-xl p-2 rounded-2xl flex items-center max-w-xl shadow-2xl border border-white/60 focus-within:ring-4 focus-within:ring-indigo-500/30 transition-all"
          >
            <span className="material-symbols-outlined text-indigo-600 ml-3 mr-2 text-2xl select-none">
              search
            </span>
            <input
              type="text"
            ...
            <button
              type="submit"
              className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-bold text-sm px-6 py-3 rounded-xl transition-all shadow-md shadow-indigo-500/25 active:scale-95 cursor-pointer"
            >
              検索する
            </button>
          </form>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div
          ...
          className="glass-card-light rounded-3xl p-8 flex flex-col justify-between relative overflow-hidden group hover:border-indigo-400/60 transition-all cursor-pointer"
        >
          <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-bl from-indigo-500/10 to-transparent rounded-bl-full pointer-events-none group-hover:scale-110 transition-transform" />
          <div>
            <div className="flex justify-between items-start mb-4">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-indigo-50 text-indigo-700 font-bold text-xs uppercase tracking-wider rounded-xl border border-indigo-100">
                <span className="material-symbols-outlined text-sm">menu_book</span> 全15章
              </span>
              <div className="w-12 h-12 rounded-2xl bg-indigo-600 text-white flex items-center justify-center shadow-lg shadow-indigo-500/25 group-hover:rotate-6 transition-transform">
          ...
          <div className="pt-6 mt-6 flex justify-between items-center border-t border-slate-200/80">
            ...
            <span className="text-indigo-600 font-bold text-sm flex items-center gap-1.5 group-hover:translate-x-1 transition-transform">
        ...
        <div
          onClick={() => onStartQuiz()}
          className="glass-card-light rounded-3xl p-8 flex flex-col justify-between relative overflow-hidden group hover:border-purple-400/60 transition-all cursor-pointer"
        >
          <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-bl from-purple-500/10 to-transparent rounded-bl-full pointer-events-none group-hover:scale-110 transition-transform" />
          <div>
            <div className="flex justify-between items-start mb-4">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-purple-50 text-purple-700 font-bold text-xs uppercase tracking-wider rounded-xl border border-purple-100">
                <span className="material-symbols-outlined text-sm">quiz</span> 実践演習
              </span>
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-purple-600 to-pink-600 text-white flex items-center justify-center shadow-lg shadow-purple-500/25 group-hover:rotate-6 transition-transform">
                <span className="material-symbols-outlined text-2xl">smartphone</span>
              </div>
            </div>
            <h2 className="text-2xl font-black text-slate-900 mb-3 group-hover:text-purple-600 transition-colors">
              アプリで問題演習に挑戦
            </h2>
            <p className="text-sm text-slate-600 leading-relaxed font-medium">
          ...
          <div className="pt-6 mt-6 flex justify-between items-center border-t border-slate-200/80">
            ...
            <span className="text-purple-600 font-bold text-sm flex items-center gap-1.5 group-hover:translate-x-1 transition-transform">
      ...
      <section className="flex flex-col gap-6">
        <div className="flex justify-between items-end border-b border-slate-200/80 pb-4">
          <div>
            <span className="text-xs font-extrabold tracking-widest text-indigo-600 uppercase">Categories</span>
            <h2 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">分野別解説</h2>
          </div>
          <button
            onClick={() => setActiveTab('table-of-contents')}
            className="text-xs sm:text-sm font-bold text-indigo-600 hover:text-indigo-700 transition-colors flex items-center gap-1 cursor-pointer"
          >
