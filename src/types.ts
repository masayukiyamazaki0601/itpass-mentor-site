...
export interface ArticleSection {
  ...
  diagram?: 'bs-pl' | 'five-profits' | 'break-even' | 'organization-chart' | 'process-visualization' | 'ppm-matrix' | 'strategy-hierarchy' | 'network' | 'database' | 'corporate-activities' | 'company-structure' | 'departments';
}
